...
public class CategoriaReportService {
    ...
    public String generateReport() {
        try {
            File file = ResourceUtils.getFile("classpath:ReporteCategorias.jasper");
...
// Exporta a PDF
            JasperExportManager.exportReportToPdfFile(jasperPrint, reportPath + "\\ReporteCategorias.pdf");
            return reportPath + "\\ReporteCategorias.pdf";
        } catch (Exception e) {
            return e.getMessage();
        }
    }
